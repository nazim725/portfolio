          ...
          <Row>
            ...
            <Col lg="4" md="3">
              <div className="about_btns d-flex flex-column align-items-center">
                ...
                <button
                  className={`about_btn ${
                    aboutFilter === 'EXPERIENCE' ? 'about_btn-active' : ''
                  }`}
                ...
                <button
                  className={`about_btn ${
                    aboutFilter === 'CERTIFICATION' ? 'about_btn-active' : ''
                  }`}
                ...
                <div className="about_content_wrapper d-flex gap-5">
                  ...
                  <div className="about_content w-75">
                    ...
                    <p>
                      ...
                      Hafez Of holy Quran. A versatile And responsible person
                      With knowledge and background in Computer Science and
                      Engineering.I am A hard working,honest and individual.I am
                      a good timekeeper and always willing to learn new things
                      and skills.I have a creative mind and always up for new
                      challanges.
                    </p>
                    <div className="social_links">
                      <h6 className="mb-4 contact-with">Contact With Me:</h6>
                      <span>
                        <a
                          target="_blank"
                      ...
                      <span>
                        <a
                          target="_blank"
                          href="https://twitter.com/NazimHabib6"
                        >
